...
const userSchema = new Schema(
  {
    name: {
      type: String,
      minlength: [3, "The name should be minimum 3 chars"], //checking whether name is atleast 3 characters
      required: true,
    },
    password: {
      type: String,
      minlength: [7, "The password should be minimum 7 chars"], //checking whether Passsword is atleast 7 characters
      required: true,
    },
    email: {
      type: String,
      ...
      validate: [isEmail, "Enter the valid email"], //validationg whether the user entered email or not  is atleast 3 characters
    },
    mobile: {
      type: Number,
